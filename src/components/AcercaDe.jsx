...
function AcercaDe() {
    return(
        <motion.div
            ...
            className="my-10 sm:mt-20 mb-20"
            id="acerca"
        >
            <h1 className="titulos text-center dark:text-white">Sobre mí</h1>
            <div className="my-6 w-[100%] sm:w-[70%] m-auto text-gray-300 text-base sm:text-lg text-pretty">
